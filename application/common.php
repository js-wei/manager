 ...
 */
function & load_wechat($type = '',$platform='') {
	$options = $platform?$platform:[
 		'token'           => 'weixin', // 填写你设定的key
        'appid'           => 'wx0ee7ee63fb439f01', // 填写高级调用功能的app id, 请在微信开发模式后台查询
        'appsecret'       => '7ba63c81987ae7dab0ea2a9d66b3b287', // 填写高级调用功能的密钥
        'encodingaeskey'  => '9Vmrld8tyQg49YPTv87kVQQAry6GkXDYPz9hnBngQFo', // 填写加密用的EncodingAESKey（可选，接口传输选择加密时必需）
        'mch_id'          => '', // 微信支付，商户ID（可选）
