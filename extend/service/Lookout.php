...
class Lookout{
	private $url=array(
		'trace_create'=>'http://api.map.baidu.com/trace/v1/service/create',
		'trace_delete'=>'http://api.map.baidu.com/trace/v1/service/delete',
		'trace_detail'=>'http://api.map.baidu.com/trace/v1/service/detail',
		'trace_list'=>'http://api.map.baidu.com/trace/v1/service/list?',
		'trace_update'=>'http://api.map.baidu.com/trace/v1/service/update',
		'trace_addcolumn'=>'http://api.map.baidu.com/trace/v1/service/addcolumn',
        'trace_updatecolumn'=>'http://api.map.baidu.com/trace/v1/service/updatecolumn',
        'trace_delcolumn'=>'http://api.map.baidu.com/trace/v1/service/delcolumn',
        'track_create'=>'http://api.map.baidu.com/trace/v1/track/create',
        'track_detail'=>'http://api.map.baidu.com/trace/v1/track/detail',
        'track_upload'=>'http://api.map.baidu.com/trace/v1/track/upload',
        'track_history'=>'http://api.map.baidu.com/trace/v1/track/history',
        'track_delete'=>'http://api.map.baidu.com/trace/v1/track/delete',
        'conf_set'=>'http://api.map.baidu.com/trace/v1/conf/set',
        'conf_get'=>'http://api.map.baidu.com/trace/v1/conf/get',
        'relation_create'=>'http://api.map.baidu.com/trace/v1/relation/create',
